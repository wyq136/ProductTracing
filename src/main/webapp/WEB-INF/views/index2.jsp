		...
		<div class="b_room">
				<div class="booking_room"><br />
					<div class="reservation">
						<div class="book-top">
							<div class="b-search" >
								<div class="boo-lef" id = "neighbor">
								<i class="sear"></i>
								<p>Neighbor</p>
								</div>
							</div>
							<div class="pick" >
								<div class="boo-lef" id ="price">
								<i class="sele"></i>
								<p>Price</p>
								</div>
							</div>
							<div class="delv" >
								<div class="boo-lef" id = "catgory">
								<!--<i class="ca-r"></i> -->
								<i class="sele"></i>
								<p>Category</p>
								</div>
						...
						<ul >
							...
							<li class="span1_of_1" id = "select_form">
								
							 </li>	
							 <p id = "selected_price">Price:0-100</p>		
							 <p id = "selected_catgory">Catgory:Thailand</p>		  
							 <li class="span1_of_3">
									<div class="date_btn">
	...
	<div class="footer" >
		<div class="container">
			<div class="footer-left">
				<p>Copyrights © 2016 Producting Tracing </p>
			</div>
